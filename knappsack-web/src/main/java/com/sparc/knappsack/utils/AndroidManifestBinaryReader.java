...
public class AndroidManifestBinaryReader {

  /**
   * Binary XML doc ending Tag
   */
  private int endDocTag = 0x00100101;
  /**
   * Binary XML start Tag
   */
  private int startTag = 0x00100102;
  /**
   * Binary XML end Tag
   */
  private int endTag = 0x00100103;
  /**
   ...
   */
  private String prtIndent(int indent, String str) {
